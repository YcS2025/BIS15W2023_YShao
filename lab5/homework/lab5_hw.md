...
```r
superhero_info <- readr::read_csv("C:/Users/SYC91/Desktop/BIS15W2023_YShao/lab5/data/heroes_information.csv", na = c("", "-99", "-"))
```
...
```r
superhero_powers <- readr::read_csv("C:/Users/SYC91/Desktop/BIS15W2023_YShao/lab5/data/super_hero_powers.csv", na = c("", "-99", "-"))
```
...
Because the two superheroes in the table above satisfy both conditions, they will both appear in two different datasets filtered by only a single condition. But in the data set that requires a height over 200 or weight greater than or equal to 450, they will only appear once. (since there will be no duplicates in this dataset)
